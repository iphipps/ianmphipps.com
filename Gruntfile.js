module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		copy: {
			target: {
				files: [
					{src: 'root/favicon.ico', dest: 'runtime/favicon.ico'},
					{src: 'root/favicon.png', dest: 'runtime/favicon.png'},
					{src: 'root/tileicon.png', dest: 'runtime/tileicon.png'},
					{src: 'root/index.php', dest: 'runtime/index.php'},
					{expand: true, cwd: 'root/', src: ['**','!**/*Thumbs.db','!**/*.sass-cache','!**/*DS_Store'], dest: 'runtime/'}
				]
			}
		},
		useminPrepare: {
		...
		concat: {
			js: {
				...
				src: [
					'root/assets/js/libraries/library.js',
					'root/assets/js/scripts/common.js',
					'root/assets/js/scripts/init.js'
				],
		...
		cssmin: {
			combine: {
				files: {
					'runtime/assets/styles/screen.min.css': ['root/assets/styles/screen.css']
				}
			}
		},
		usemin: {
